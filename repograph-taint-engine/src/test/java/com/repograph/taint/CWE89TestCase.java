...
public class CWE89TestCase {

	private static final Logger LOGGER = LoggerFactory.getLogger(CWE89TestCase.class);
	...
	public static void main(String[] args) {
		Path path = Paths.get("/Users/leolu/Downloads/cwe-top25-5/absolute_match_25_cwe_id_testcases/src/testcases/CWE89_SQL_Injection");
		...
		CWE89TestCase cwe476TestCase = new CWE89TestCase();
	...
	protected ITaintSolver createTaintSolver(CallGraph callgraph) throws IOException {
		...
		if (isDir(wrapperFile)) {
			wrapper = new SummaryTaintWrapper("CWE_89", wrapperFile, callgraph, pa);
