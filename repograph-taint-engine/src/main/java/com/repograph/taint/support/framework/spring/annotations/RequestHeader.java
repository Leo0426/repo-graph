...
public class RequestHeader implements IAnnotation {
	String value;
	String name;
	boolean required;
	String defaultValue;

	public RequestHeader(ElementValue value, ElementValue name, ElementValue required, ElementValue defaultValue) {
