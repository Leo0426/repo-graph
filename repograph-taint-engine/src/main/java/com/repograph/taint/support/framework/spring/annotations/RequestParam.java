...
public class RequestParam implements IAnnotation {
	String value;
	String name;
	boolean required;
	String defaultValue;

	public RequestParam(ElementValue value, ElementValue name, ElementValue required, ElementValue defaultValue) {
